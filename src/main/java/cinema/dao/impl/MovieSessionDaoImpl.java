...
public class MovieSessionDaoImpl implements MovieSessionDao {
    ...
    public MovieSession add(MovieSession movieSession) {
        ...
        try {
            ...
            transaction.commit();
            LOGGER.info("A movie session was created. Params: movie session={}",
                    movieSession);
            return movieSession;
        } catch (Exception e) {
            if (transaction != null) {
            ...
            LOGGER.error("Couldn't create a movie session. Params: movie session={}",
                    movieSession);
    ...
    public List<MovieSession> findAvailableSessions(Long movieId, LocalDate date) {
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            ...
            LOGGER.info("Got available movie sessions. Params: movie id={}, date={}",
                    movieId, date);
            return session.createQuery(criteriaQuery).getResultList();
        } catch (Exception e) {
            LOGGER.error("Couldn't get available movie sessions. Params: movie id={}, date={}",
                    movieId, date);
    ...
    public Optional<MovieSession> get(Long id) {
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            ...
            LOGGER.info("Got a movie session. Params: id={}", id);
            return query.uniqueResultOptional();
        } catch (Exception e) {
            LOGGER.error("Couldn't get a movie session. Params: id={}", id);
